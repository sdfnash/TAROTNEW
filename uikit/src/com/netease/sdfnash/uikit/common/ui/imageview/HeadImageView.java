package com.netease.sdfnash.uikit.common.ui.imageview;
...
public class HeadImageView extends CircleImageView {
     ...
     * ImageLoader异步加载
     */
    public void doLoadImage(final boolean needLoad, final String tag, final String url, final int thumbSize) {
        if (needLoad) {
