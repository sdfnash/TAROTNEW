...
import com.tarot.sdfnash.tarot.main.activity.AboutActivity;
import com.tarot.sdfnash.tarot.main.activity.CustomNotificationActivity;
import com.tarot.sdfnash.tarot.main.activity.MainActivity;
import com.tarot.sdfnash.tarot.main.activity.NoDisturbActivity;
...
public class MineFragment extends MainTabFragment  implements SettingsAdapter.SwitchChangeListener {
...
//        }
    ...
    private void initUI() {
        initItems();
        listView = (ListView) getView().findViewById(R.id.settings_listview);
        View footer = LayoutInflater.from(getContext()).inflate(R.layout.settings_logout_footer, null);
