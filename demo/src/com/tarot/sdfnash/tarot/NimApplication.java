...
import com.netease.sdfnash.uikit.ImageLoaderKit;
...
import com.netease.sdfnash.uikit.contact.ContactProvider;
import com.netease.sdfnash.uikit.contact.core.query.PinYin;
...
import com.tarot.sdfnash.tarot.common.util.crash.AppCrashHandler;
import com.tarot.sdfnash.tarot.common.util.sys.SystemUtil;
import com.tarot.sdfnash.tarot.config.ExtraOptions;
...
import com.tarot.sdfnash.tarot.contact.ContactHelper;
import com.tarot.sdfnash.tarot.main.activity.WelcomeActivity;
import com.tarot.sdfnash.tarot.rts.activity.RTSActivity;
import com.tarot.sdfnash.tarot.session.NimDemoLocationProvider;
...
public class NimApplication extends Application {
    ...
    private LoginInfo getLoginInfo() {
        ...
        String account_yx = Preferences.getYXAcount();
        String token_yx = Preferences.getYXToken();
        if (!TextUtils.isEmpty(account) && !TextUtils.isEmpty(token)) {
            DemoCache.setAccount(account, account_yx);
            return new LoginInfo(account_yx, token_yx);
        } else {
            return null;
        }
    }
