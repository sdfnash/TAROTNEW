...
import com.tarot.sdfnash.tarot.session.extension.CustomAttachParser;
import com.tarot.sdfnash.tarot.session.extension.CustomAttachment;
import com.tarot.sdfnash.tarot.session.extension.GuessAttachment;
import com.tarot.sdfnash.tarot.session.extension.RTSAttachment;
import com.tarot.sdfnash.tarot.session.extension.SnapChatAttachment;
import com.tarot.sdfnash.tarot.session.extension.StickerAttachment;
import com.tarot.sdfnash.tarot.session.search.SearchMessageActivity;
import com.tarot.sdfnash.tarot.session.viewholder.MsgViewHolderAVChat;
import com.tarot.sdfnash.tarot.session.viewholder.MsgViewHolderDefCustom;
import com.tarot.sdfnash.tarot.session.viewholder.MsgViewHolderFile;
import com.tarot.sdfnash.tarot.session.viewholder.MsgViewHolderGuess;
import com.tarot.sdfnash.tarot.session.viewholder.MsgViewHolderRTS;
